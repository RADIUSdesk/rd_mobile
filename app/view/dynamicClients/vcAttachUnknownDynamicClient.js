...
Ext.define('RdMobile.view.dynamicClients.vcAttachUnknownDynamicClient', {
    extend  : 'Ext.app.ViewController',
    alias   : 'controller.vcAttachUnknownDynamicClient',
    config : {
        urlAttach  : '/cake4/rd_cake/dynamic-clients/add.json'
    },
    control : {
    	'#chkSessionAutoClose': {
