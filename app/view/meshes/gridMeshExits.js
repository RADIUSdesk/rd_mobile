Ext.define('RdMobile.view.meshes.gridMeshExits', {
    extend  : 'Ext.grid.Grid',
    xtype   : 'gridMeshExits',
    emptyText: 'No MESH Exits Found',
    config  : {
        compdata: undefined,
    },
    hideHeaders: true,
    ...
    initialize: function () {
        ...
        me.setStore(Ext.create(Ext.data.Store,{
            model: 'RdMobile.model.mMeshExit', //FIXME MODEL 
            proxy: {
                type        :'ajax',
                url     	: '/cake4/rd_cake/meshes/mesh_exits_index.json',
                format      : 'json',
                reader: {
			        type: 'json',
			        rootProperty: 'items',
