...
Ext.define('RdMobile.view.aps.cntApViewSsidsGraph', {
    extend  : 'Ext.Container',
    xtype   : 'cntApViewSsidsGraph',
    controller  : 'vcApViewSsidsGraph',
    layout	: 'fit',
    requires	: [
        'RdMobile.view.aps.vcApViewSsidsGraph',
        'RdMobile.view.aps.cmbApViewSsids',
		        ...
		        items: [
					...
					{ ui: 'normal',  iconCls: 'x-fa fa-calendar', 	itemId : 'btnDate' },					
					{
						...
						tpl	    : new Ext.XTemplate(
							'<div style="color:#3e3f40;text-align: center;font-size:small">{ap_name}',
