...
Ext.define('RdMobile.view.aps.gridAccessPointEntries', {
    ...
    initialize: function () {
        ...
        me.setStore(Ext.create(Ext.data.Store,{
            model: 'RdMobile.model.mAccessPointEntry', //FIXME MODEL 
            proxy: {
                type        :'ajax',
                url     	: '/cake4/rd_cake/ap-profiles/ap-profile-entries-index.json',
                format      : 'json',
                reader: {
			        type: 'json',
			        rootProperty: 'items',
